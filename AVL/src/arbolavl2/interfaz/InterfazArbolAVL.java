...
import arbolRN.PanelRN;
import arbolRN.Arbol;
import arbolRN.PanelAVL;
...
public class InterfazArbolAVL extends JFrame {
    ...
    /**
     * Clase principal de la logica RN
     */
    private Arbol arbolRN;
     ...
     */
    private PanelRN comunicacionRN;
    ...
    public InterfazArbolAVL() {
        ...
        comunicacionRN = new PanelRN(arbolRN);
        comunicacionRN.setBounds(0, 0, pnlVisorNodoRN.getWidth(), pnlVisorNodoRN.getHeight());
        pnlVisorNodoRN.add(comunicacionRN);
        pnlVisorNodoRN.setVisible(false);
        ...
        /*for (int i = 0; i < 10; i++) {
            ...
            comunicacionRN.añadirNodo(numero);
    ...
    String[] darDatosTablaRN() {
        String[] datos = {Integer.toString(arbolRN.darNumeroNodo()),
            Integer.toString(arbolRN.darRotacionSimpleDerecha()),
            Integer.toString(arbolRN.darRotacionSimpleIzquierda()),
            Integer.toString(arbolRN.darRotacionDobleDerecha()),
            Integer.toString(arbolRN.darRotacionDobleIzquierda())
        };
        return datos;
    }
    ...
    void actualizarTabla() {
        ...
        String[] tablaRN = darDatosTablaRN();

        panelCentral.actualizarTablaAVL(tablaAVL);
        panelCentral.actualizarTablaRN(tablaRN);
    }
    ...
    private void btnAñadirActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            comunicacionRN.añadirNodo(nodo);
